...
const DataShow=(props)=>{
    return (
        ...
        {!props.isloading&&!props.error&&<div className="white-Box white-container"> <div className="data-box">
                ...
                { <span>  <span>active :</span> <span>{props.ObtainedData["active"]}</span><br></br><br></br> </span>}           </div>
      ...
      { <span><span>Todaydeaths :</span> <span>{props.ObtainedData["todayDeaths"]}</span><br></br><br></br></span>}
                  ...
                  { <span><span>recovered :</span> <span>{props.ObtainedData["recovered"]}</span><br></br><br></br></span>}    </div> </div> }
                  {props.isloading&&!props.error&&<div className="white-Box white-container" ><h3>loading...</h3> </div>}
